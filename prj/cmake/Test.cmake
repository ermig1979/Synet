if((SYNET_TEST STREQUAL "inference_engine") OR (SYNET_TEST STREQUAL "all"))
	...
	target_link_libraries(test_inference_engine ${IE_BIN_LIBS} ${SIMD_LIB} CvtCore Synet -ldl -lpthread)
endif()
...
if((SYNET_TEST STREQUAL "onnx") OR (SYNET_TEST STREQUAL "all"))
	...
	if(NOT SYNET_USE_CONAN_PACKAGES)
		add_dependencies(test_onnx make_ort)
	endif()
	if(SYNET_USE_CONAN_PACKAGES)
		target_link_libraries(test_onnx ${ORT_LIBS} ONNX::onnx ${SIMD_LIB} CvtOnnx CvtCore Synet -ldl -lpthread)
	else()
		target_link_libraries(test_onnx ${ORT_LIBS} ${SIMD_LIB} CvtOnnx CvtCore Synet -ldl -lpthread)
	endif()
endif()
...
if((SYNET_TEST STREQUAL "quantization") OR (SYNET_TEST STREQUAL "all"))	
	...
	target_link_libraries(test_quantization ${SIMD_LIB} CvtCore Synet -ldl -lpthread)
endif()
...
if((SYNET_TEST STREQUAL "optimizer") OR (SYNET_TEST STREQUAL "all"))	
	...
	target_link_libraries(test_optimizer ${SIMD_LIB} CvtCore Synet -ldl -lpthread)
endif()
...
if((SYNET_TEST STREQUAL "bf16") OR (SYNET_TEST STREQUAL "all"))	
	...
	target_link_libraries(test_bf16 ${SIMD_LIB} CvtCore Synet -ldl -lpthread)
endif()
