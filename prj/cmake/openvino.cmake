if(SYNET_USE_BIN)
  set(IE_ROOT_DIR ${ROOT_DIR}/3rd/bin/openvino)
  ...
  set(IE_BIN_LIBS
    ...
    ${CMAKE_BINARY_DIR}/libopenvino_ir_frontend.so
    ${CMAKE_BINARY_DIR}/libopenvino_onnx_frontend.so
    ${CMAKE_BINARY_DIR}/libopenvino.so)

  add_custom_command(
    OUTPUT ${IE_BIN_LIBS}
    COMMAND ${CMAKE_COMMAND} -E copy ${IE_BIN_LIBS_IN} ${CMAKE_BINARY_DIR}
...
elseif(SYNET_USE_CONAN_PACKAGES)
  ...
  set(IE_BIN_LIBS openvino::runtime openvino::frontend::onnx)
else()
  ...
  add_custom_command(
    OUTPUT ${IE_BIN_LIBS}
    COMMAND cmake .. ${IE_BUILD_OPTIONS} && $(MAKE)
