...
cmake ../prj/cmake -DMODE=$TEST_MODE -DTOOLCHAIN="/usr/bin/c++" -DSYNET_INFO=$ECHO -DSIMD_AVX512=1 -DSIMD_AVX512VNNI=1 -DBLIS=0 -DPERF_STAT=1 -DSYNET_ORT=1 -DCMAKE_BUILD_TYPE=Release
